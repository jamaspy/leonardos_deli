            ...
            <div className="hidden md:block md:px-4 lg:px-0 ">
                <div className="bg-offWhite flex flex-row w-full mt-8 shadow-md">
                    ...
                    <div className="flex-1  w-full text-center flex items-center flex-col justify-center px-4">
                        ...
                        <p className="text-xs lg:text-base">
                            Bitey blues, stinky washed rind to nutty and delicious hard cheeses. There’s goat, sheep and
                            cows milk to suit every taste; an everchanging selection of over 30 local and international
                            cheeses from the best producers. We balance our menu between what you expect (parmigiano,
                            cheddar, brie, comte) and what will surprise you (cashel blue from Ireland, American rogue
                            river blue, Dutch wyngaard semi-hard goat, espresso rubbed Wisconsin cheddar)?.
                        </p>
                    </div>
                </div>
                <div className="bg-oliveGreen flex flex-row w-full mt-12 shadow-md">
                    <div className="flex-1  w-full text-center flex items-center flex-col justify-center px-4">
                        ...
                        <p className="text-xs lg:text-base">
                            World-class meats (turkey, pork, venison and beef) from a select group of local and
                            international producers. Everything from mortadella and salamis to wagyu bresaola,
                            prosciutto and iberico. Light, subtle, strong and spicy flavours are all found here. Our
                ...
                <div className="bg-offWhite flex flex-row w-full mt-12 shadow-md">
                    ...
                    <div className="flex-1  w-full text-center flex items-center flex-col justify-center px-2">
                        ...
                        <p className="text-xs lg:text-base">
                            Classic cocktails include our signature olive brine and cold brew (coffee) martini. Our wine
                            list changes with seasons to reflect the best local and international producers. We
                            currently stock over 30 wines across rose, white, red and skin contact. Something for
                            everyone across taste and budget, beers too - pale ales, lagers and a unique guest beer each
                            week. Our non-alcoholic range is curated and delicious.
                        </p>
                    </div>
                </div>
            </div>
